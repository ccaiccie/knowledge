...
- [Shared VPC / shared-services VPC centralized firewall architecture](#shared-vpc--shared-services-vpc-centralized-firewall-architecture)
  - [Why Shared VPC is useful for firewall insertion](#why-shared-vpc-is-useful-for-firewall-insertion)
  - [Shared VPC + PBR + internal passthrough NLB + firewall](#shared-vpc--pbr--internal-passthrough-nlb--firewall)
    - [East-west packet flow](#east-west-packet-flow)
  - [Shared VPC + Cloud Interconnect or HA VPN ingress](#shared-vpc--cloud-interconnect-or-ha-vpn-ingress)
  - [Shared VPC + Internet egress](#shared-vpc--internet-egress)
  - [Where should the firewalls live?](#where-should-the-firewalls-live)
  - [Shared VPC versus a separate security VPC](#shared-vpc-versus-a-separate-security-vpc)
    - [Shared VPC](#shared-vpc)
    - [Separate security VPC](#separate-security-vpc)
  - [Shared VPC + Cloud NGFW Enterprise](#shared-vpc--cloud-ngfw-enterprise)
  - [Shared VPC + NSI in-band](#shared-vpc--nsi-in-band)
  - [Shared VPC + NCC Router Appliance](#shared-vpc--ncc-router-appliance)
  - [Selective inspection with VM tags](#selective-inspection-with-vm-tags)
  - [Shared VPC operational checks](#shared-vpc-operational-checks)
    - [Verify host/service project relationship](#verify-hostservice-project-relationship)
    - [Verify shared VPC configuration](#verify-shared-vpc-configuration)
    - [Verify PBR](#verify-pbr)
    - [Verify ILB firewall pool health](#verify-ilb-firewall-pool-health)
    - [Verify Router Appliance BGP when used](#verify-router-appliance-bgp-when-used)
  - [Shared VPC common mistakes](#shared-vpc-common-mistakes)
