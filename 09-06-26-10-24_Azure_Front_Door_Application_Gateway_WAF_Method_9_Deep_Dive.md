...
## Table of contents
  ...
  - [Supplied and supporting URLs](#supplied-and-supporting-urls)
- [1. What Method 9 actually is](#1-what-method-9-actually-is)
- [2. Three practical architectures](#2-three-practical-architectures)
  - [2.1 Pattern A — Azure Front Door WAF only](#21-pattern-a--azure-front-door-waf-only)
  - [2.2 Pattern B — Application Gateway WAF v2 only](#22-pattern-b--application-gateway-waf-v2-only)
  - [2.3 Pattern C — Front Door WAF → Application Gateway WAF](#23-pattern-c--front-door-waf--application-gateway-waf)
- [3. Azure Front Door WAF architecture and packet flow](#3-azure-front-door-waf-architecture-and-packet-flow)
  - [3.1 Detailed request flow](#31-detailed-request-flow)
- [4. Front Door WAF rule processing](#4-front-door-waf-rule-processing)
  - [4.1 Detection versus Prevention](#41-detection-versus-prevention)
  - [4.2 Managed Default Rule Set (DRS)](#42-managed-default-rule-set-drs)
  - [4.3 Custom rules](#43-custom-rules)
  - [4.4 Rate limiting](#44-rate-limiting)
- [5. Front Door origin lockdown](#5-front-door-origin-lockdown)
  - [5.1 Preferred: Private Link with Front Door Premium](#51-preferred-private-link-with-front-door-premium)
  - [5.2 Public origin: service tag plus Front Door profile ID](#52-public-origin-service-tag-plus-front-door-profile-id)
- [6. Front Door implementation example — Azure CLI](#6-front-door-implementation-example--azure-cli)
  - [6.1 Variables](#61-variables)
  - [6.2 Create Front Door Premium](#62-create-front-door-premium)
  - [6.3 Create endpoint](#63-create-endpoint)
  - [6.4 Create origin group](#64-create-origin-group)
  - [6.5 Create WAF policy](#65-create-waf-policy)
  - [6.6 Add managed rules](#66-add-managed-rules)
  - [6.7 Associate WAF with endpoint/domain](#67-associate-waf-with-endpointdomain)
- [7. Application Gateway WAF v2 architecture and packet flow](#7-application-gateway-waf-v2-architecture-and-packet-flow)
  - [7.1 Detailed flow](#71-detailed-flow)
  - [7.2 Routing still matters on the backend side](#72-routing-still-matters-on-the-backend-side)
- [8. Application Gateway implementation example — Azure CLI](#8-application-gateway-implementation-example--azure-cli)
  - [8.1 Network and public IP](#81-network-and-public-ip)
  - [8.2 Create WAF policy](#82-create-waf-policy)
  - [8.3 Create WAF_v2 gateway](#83-create-waf_v2-gateway)
  - [8.4 Listener example](#84-listener-example)
  - [8.5 Routing rule example](#85-routing-rule-example)
- [9. Layered Front Door → Application Gateway design](#9-layered-front-door--application-gateway-design)
  - [9.1 Public App Gateway origin](#91-public-app-gateway-origin)
  - [9.2 Private Link App Gateway origin](#92-private-link-app-gateway-origin)
- [10. TLS design](#10-tls-design)
  - [10.1 Front Door only](#101-front-door-only)
  - [10.2 Application Gateway only](#102-application-gateway-only)
  - [10.3 Layered design](#103-layered-design)
- [11. Combining WAF with Azure Firewall or an NGFW](#11-combining-waf-with-azure-firewall-or-an-ngfw)
  - [11.1 Application Gateway before Azure Firewall](#111-application-gateway-before-azure-firewall)
  - [11.2 Azure Firewall before Application Gateway](#112-azure-firewall-before-application-gateway)
- [12. High availability and failover](#12-high-availability-and-failover)
  - [Front Door](#front-door)
  - [Application Gateway WAF v2](#application-gateway-waf-v2)
  - [Layered failure domains](#layered-failure-domains)
- [13. Verification commands and expected state](#13-verification-commands-and-expected-state)
  - [13.1 Front Door profile and endpoint](#131-front-door-profile-and-endpoint)
  - [13.2 Front Door origins](#132-front-door-origins)
  - [13.3 Front Door WAF policy](#133-front-door-waf-policy)
  - [13.4 WAF security-policy association](#134-waf-security-policy-association)
  - [13.5 Application Gateway state](#135-application-gateway-state)
  - [13.6 Listeners](#136-listeners)
  - [13.7 Routing rules](#137-routing-rules)
  - [13.8 Backend health](#138-backend-health)
...
- [15. Troubleshooting by symptom](#15-troubleshooting-by-symptom)
  - [Symptom A — Malicious request reaches the application](#symptom-a--malicious-request-reaches-the-application)
  - [Symptom B — Legitimate request gets 403 after Prevention is enabled](#symptom-b--legitimate-request-gets-403-after-prevention-is-enabled)
  - [Symptom C — Front Door returns 502/503](#symptom-c--front-door-returns-502503)
  - [Symptom D — Application Gateway backend unhealthy](#symptom-d--application-gateway-backend-unhealthy)
  - [Symptom E — Direct App Gateway works but Front Door path fails](#symptom-e--direct-app-gateway-works-but-front-door-path-fails)
  - [Symptom F — Client IP appears as proxy/firewall IP](#symptom-f--client-ip-appears-as-proxyfirewall-ip)
  - [Symptom G — WAF logs show `Matched` but request was not blocked](#symptom-g--waf-logs-show-matched-but-request-was-not-blocked)
- [16. Common mistakes](#16-common-mistakes)
- [17. Decision matrix](#17-decision-matrix)
- [18. Recommended production solution](#18-recommended-production-solution)
