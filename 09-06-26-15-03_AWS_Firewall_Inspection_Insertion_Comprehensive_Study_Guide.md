...
- [URLs reviewed](#urls-reviewed)
- [1. The problem AWS firewall insertion must solve](#1-the-problem-aws-firewall-insertion-must-solve)
- [2. Decision matrix — major inspection methods](#2-decision-matrix--major-inspection-methods)
- [3. Gateway Load Balancer fundamentals](#3-gateway-load-balancer-fundamentals)
- [4. Method 1 — AWS Network Firewall inside a workload or edge VPC](#4-method-1--aws-network-firewall-inside-a-workload-or-edge-vpc)
  - [4.1 Internet egress](#41-internet-egress)
  - [4.2 Internet ingress with VPC ingress routing](#42-internet-ingress-with-vpc-ingress-routing)
  - [4.3 Important limitations](#43-important-limitations)
- [5. Method 2 — Distributed GWLBE with a centralized third-party firewall fleet](#5-method-2--distributed-gwlbe-with-a-centralized-third-party-firewall-fleet)
  - [5.1 Egress packet flow](#51-egress-packet-flow)
  - [5.2 Why distributed endpoints are attractive](#52-why-distributed-endpoints-are-attractive)
- [6. Method 3 — Centralized GWLB inspection VPC with Transit Gateway](#6-method-3--centralized-gwlb-inspection-vpc-with-transit-gateway)
  - [6.1 TGW routing domains](#61-tgw-routing-domains)
  - [6.2 Appliance mode](#62-appliance-mode)
  - [6.3 East-west flow](#63-east-west-flow)
  - [6.4 Centralized Internet egress](#64-centralized-internet-egress)
- [7. Method 4 — AWS Network Firewall centralized with Transit Gateway](#7-method-4--aws-network-firewall-centralized-with-transit-gateway)
  - [7.1 Hybrid Direct Connect path](#71-hybrid-direct-connect-path)
  - [7.2 Direct Connect building blocks](#72-direct-connect-building-blocks)
- [8. Method 5 — Direct NVA next-hop insertion without GWLB](#8-method-5--direct-nva-next-hop-insertion-without-gwlb)
  - [8.1 Requirements](#81-requirements)
  - [8.2 Limitations](#82-limitations)
- [9. Method 6 — Legacy TGW + directly attached firewall VPC](#9-method-6--legacy-tgw--directly-attached-firewall-vpc)
- [10. Method 7 — TGW + VPN attachment to firewall appliances](#10-method-7--tgw--vpn-attachment-to-firewall-appliances)
- [11. Method 8 — Internet ingress inspection before ALB or NLB](#11-method-8--internet-ingress-inspection-before-alb-or-nlb)
  - [11.1 ALB](#111-alb)
  - [11.2 NLB](#112-nlb)
  - [11.3 Centralized ingress to other VPCs](#113-centralized-ingress-to-other-vpcs)
- [12. Method 9 — ELB sandwich](#12-method-9--elb-sandwich)
- [13. Method 10 — AWS WAF / CloudFront / ALB WAF as Layer-7 inspection](#13-method-10--aws-waf--cloudfront--alb-waf-as-layer-7-inspection)
- [14. Method 11 — AWS Cloud WAN service insertion](#14-method-11--aws-cloud-wan-service-insertion)
  - [14.1 Core concept](#141-core-concept)
  - [14.2 Why this matters](#142-why-this-matters)
- [15. Method 12 — VPC Route Server + BGP-based NVA insertion](#15-method-12--vpc-route-server--bgp-based-nva-insertion)
- [16. Transit Gateway + Direct Connect inspection in detail](#16-transit-gateway--direct-connect-inspection-in-detail)
  - [16.1 On-prem → VPC inspected flow](#161-on-prem--vpc-inspected-flow)
- [17. NAT placement and source-address visibility](#17-nat-placement-and-source-address-visibility)
  - [17.1 Firewall before NAT](#171-firewall-before-nat)
  - [17.2 NAT before firewall](#172-nat-before-firewall)
  - [17.3 Inbound DNAT and third-party appliances](#173-inbound-dnat-and-third-party-appliances)
- [18. ALB, NLB, GWLB — do not confuse their roles](#18-alb-nlb-gwlb--do-not-confuse-their-roles)
- [19. Route-table configuration examples](#19-route-table-configuration-examples)
  - [19.1 Spoke default route to TGW](#191-spoke-default-route-to-tgw)
  - [19.2 Workload default route to GWLBE](#192-workload-default-route-to-gwlbe)
  - [19.3 TGW route forcing traffic to inspection attachment](#193-tgw-route-forcing-traffic-to-inspection-attachment)
  - [19.4 Inspect TGW routes](#194-inspect-tgw-routes)
- [20. Gateway Load Balancer verification](#20-gateway-load-balancer-verification)
  - [20.1 Describe GWLB](#201-describe-gwlb)
  - [20.2 Target health](#202-target-health)
  - [20.3 Endpoint state](#203-endpoint-state)
- [21. Transit Gateway verification workflow](#21-transit-gateway-verification-workflow)
  - [21.1 Attachment inventory](#211-attachment-inventory)
  - [21.2 Route-table association](#212-route-table-association)
  - [21.3 Route propagation](#213-route-propagation)
- [22. Network Firewall verification](#22-network-firewall-verification)
  - [22.1 Describe firewall](#221-describe-firewall)
  - [22.2 Describe firewall policy](#222-describe-firewall-policy)
- [23. Packet capture and telemetry strategy](#23-packet-capture-and-telemetry-strategy)
- [24. High availability and failover](#24-high-availability-and-failover)
  - [24.1 GWLB](#241-gwlb)
  - [24.2 AWS Network Firewall](#242-aws-network-firewall)
  - [24.3 TGW appliance mode](#243-tgw-appliance-mode)
  - [24.4 Active/standby firewall vendors](#244-activestandby-firewall-vendors)
- [25. MTU and encapsulation considerations](#25-mtu-and-encapsulation-considerations)
- [26. Common mistakes](#26-common-mistakes)
- [27. Troubleshooting by symptom](#27-troubleshooting-by-symptom)
- [28. Architecture selection guidance](#28-architecture-selection-guidance)
- [29. Recommended enterprise reference architecture](#29-recommended-enterprise-reference-architecture)
- [30. Final validation checklist](#30-final-validation-checklist)
- [Sources](#sources)
